#
#  Be sure to run `pod spec lint iHAKWalk.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A customisable walkthrough view built on Swift that can be used
  ...
  s.author             = { "Hassan Ahmed" => "hassandotahmed@gmail.com" }
  # Or just: s.author    = "Hassan Ahmed"
  # s.authors            = { "Hassan Ahmed" => "hassan.ahmed@arpatech.com" }
  # s.social_media_url   = "http://twitter.com/Hassan Ahmed"
  ...
  s.source       = { :git => "https://github.com/ihak/iHAKWalk.git", :tag => "#{s.version}" }
